...
namespace Voidless
{
	...
	{
		public const int SIZE_BITS_SHORT = sizeof(short) * 8;
		public const int SIZE_BITS_INT = sizeof(int) * 8;
		public const int SIZE_BITS_LONG = sizeof(long) * 8;
		public const string ALPHABET = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
		public const string PATH_SCRIPTABLE_OBJECTS = "Voidless/Scriptable Objects";
		public const string EDITOR_DATA_KEY_MAPPING_PATH = "Path_InputMapping_File";
		...
		/// <returns>Returns object's ToString, but it returns a default "NULL" if the object is null.</returns>
		public static string ToStringEvenIfNull<T>(this T _object) where T : class
		{
