...
namespace Voidless
{
	public static class VJSONSerializer
	{
		...
		public static string SerializeToJSON<T>(this T _item, string _path, bool _prettyPath = false)
		{
			string json = JsonUtility.ToJson(_item, _prettyPath);
		...
		public static string SerializeToJSONIntoTextAsset<T>(this T _item, TextAsset _file)
		{
