...
namespace Voidless
{
	...
	public static class VColor
	{
		...
		/// <summary>Gets unambiguous color given an enum.</summary>
		/// <param name="_tag">UnambiguousColor enum value.</param>
		/// <returns>Color according to the UnambiguousColor enum.</returns>
		public static Color GetUnambiguousColor(UnambiguousColor _tag = UnambiguousColor.White)
		{
			switch(_tag)
			{
				case UnambiguousColor.Red:			return Color.red;
				case UnambiguousColor.Green:		return Color.green;
				case UnambiguousColor.Blue:			return Color.blue;
				case UnambiguousColor.Cyan:			return Color.cyan;
				case UnambiguousColor.Yellow:		return Color.yellow;
				case UnambiguousColor.Magenta:		return Color.magenta;
				case UnambiguousColor.Black:		return Color.black;
				case UnambiguousColor.White:		return Color.white;
				case UnambiguousColor.Gray:
				case UnambiguousColor.Grey:			return Color.gray;
				case UnambiguousColor.Transparent:	return VColor.transparent;
				case UnambiguousColor.Orange:		return VColor.orange;
				case UnambiguousColor.Purple:		return VColor.purple;
				case UnambiguousColor.Pink:			return VColor.pink;
				case UnambiguousColor.Brown:		return VColor.brown;
